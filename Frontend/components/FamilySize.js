...
const FamilySize = () => {
    ...
    const plans = [
        { id: 1, name: "1 Bedroom Plans", image: "./7.jpg", link: "/by-size/1-bedroom", description: "Perfect for couples or individuals" },
        { id: 2, name: "2 Bedroom Plans", image: "./2.jpg", link: "/by-size/2-bedroom", description: "Perfect for small families" },
        { id: 3, name: "3 Bedroom Plans", image: "./5.jpg", link: "/by-size/3-bedroom", description: "Perfect for families" },
        { id: 4, name: "4 Bedroom Plans", image: "./4.jpg", link: "/by-size/4-bedroom", description: "Perfect for growing families" },
        { id: 5, name: "5+ Bedroom Plans", image: "./3.jpg", link: "/by-size/5-plus-bedroom", description: "Perfect for large families" },
    ];
                    ...
                    >
                        {plans.map((plan, index) => (
                            <Link 
                                ...
                                className={`snap-start flex-none w-72 h-96 relative rounded-lg overflow-hidden shadow-md transition-all duration-300 transform ${

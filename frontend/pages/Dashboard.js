    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-5 bg-gray-50 border-b">
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="text-2xl font-bold text-gray-800 mt-1">{filteredProducts.length}</p>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                ...
                <tr key={product.id || idx} className="hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500 line-clamp-1">
                          {product.description?.substring(0, 50) || 'No description available'}
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full ${
                      ...
                      product.stock < 3 ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'
                    }`}>
                      {product.stock || 0}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end space-x-3">
                      <button 
                        className="text-gray-500 hover:text-indigo-600 p-1.5 rounded-lg hover:bg-indigo-50 transition-colors"
                        title="View"
                      >
                        <Eye size={18} />
                      </button>

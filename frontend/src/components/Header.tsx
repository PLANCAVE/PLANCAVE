        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="group text-white hover:text-teal-200 transition-all">
            <div className="flex flex-col items-start leading-none">
              <span className="mt-1 text-[1.25rem] sm:text-[1.5rem] font-serif tracking-[0.34em] drop-shadow-[0_10px_24px_rgba(0,0,0,0.55)]">
                RAMANICAVE
              </span>
              <span className="mt-1 text-[10px] uppercase tracking-[0.42em] text-white/60 group-hover:text-white/80 transition-colors">
                Premium house plans
              </span>
            </div>
          </Link>
